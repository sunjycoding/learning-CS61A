...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for num_rolls in range(1, 11):
        current_average_score = averaged_roll_dice(num_rolls, dice)
        if current_average_score > max_score:
            max_score = current_average_score
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    rolling_score = boar_brawl(score, opponent_score)
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    increased_score = new_score - score
